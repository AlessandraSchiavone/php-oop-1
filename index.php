<?php 
    ...
    $trailer1 = "https://www.youtube.com/watch?v=tt_Lcw9LOco";
    $poster2="https://pad.mymovies.it/filmclub/2013/12/226/locandina.jpg";
    $overview2="Manchester, primi anni '50. Alan Turing, brillante matematico ed esperto di crittografia, viene interrogato dall'agente di polizia che lo ha arrestato per atti osceni. Turing inizia a raccontare la sua storia partendo dall'episodio di maggiore rilevanza pubblica: il periodo, durante la Seconda Guerra Mondiale, in cui fu affidato a lui e ad un piccolo gruppo di cervelloni, fra cui un campione di scacchi e un'esperta di enigmistica, il compito di decrittare il codice Enigma, ideato dai Nazisti per comunicare le loro operazioni militari in forma segreta. È il primo di una serie di flashback che scandaglieranno la vita dello scienziato morto suicida a 41 anni e considerato oggi uno dei padri dell'informatica in quanto ideatore di una macchina progenitrice del computer.
    ...
    $genres2=[
        ...
        "storico",
        "thriller"];
    $trailer2="https://www.youtube.com/watch?v=nuPZUUED5uk";
     ?>
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&family=Uchen&display=swap" rel="stylesheet">
...
<body>
    <?php 
        ...
        $movie1 = new Movie("La teoria del tutto ", "it", 5.5, $overview1,$poster1,$actors1,$genres1,$trailer1);
        $movie2 = new Movie("The Imitation Game ", "en", 7.2, $overview2,$poster2,$actors2,$genres2,$trailer2);
        // $movie2 = new Movie();
    ?>
    <main>
        <article class="movie">
